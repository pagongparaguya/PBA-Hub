                ...
                <fieldset>
                    ...
                    <br>
                        <div class="small-12 large-6 medium-6 columns">
                            ...
                            <input type="text" name="fname" placeholder="First Name" <?php if(!empty($fname)){?>value="<?php echo $fname?>" <?php } ?> aria-label="First Name" required maxlength="40"/>
                            <input type="text" name="lname" placeholder="Last Name" <?php if(!empty($lname)){?>value="<?php echo $lname?>" <?php } ?> aria-label="Last Name" required maxlength="30"/>
                          ...
                          <div class="small-12 large-6 medium-6 columns signup-account-info">
                            ...
                            <input type="text" name="user" placeholder="Username" aria-label="Username" required maxlength="20"/>
                            <input type="password" name="pass" id="pass" placeholder="Password" aria-label="Password" required maxlength="20"/>
                            <input type="password" name="cpass" id="cpass" placeholder="Confirm Password" aria-label="Confirm Password" required maxlength="20"/>

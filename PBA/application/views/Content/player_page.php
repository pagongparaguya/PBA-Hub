    ...
    <div class="small-12 small-centered medium-12 large-10 large-centered columns">
      ...
      <hr class="hr-dotted">  
        <table id="searchTable" class="display" cellspacing="0" width="100%">
          <thead>
          <tr>
            <th width="50%" style="text-align: center;" class="table-header"><img src="<?php echo base_url();?>/assets/img/basketball.png" /><span>PLAYER</span></th>
            <th width="50%" style="text-align: center;" class="table-header cursor-no-pointer"><img src="<?php echo base_url();?>/assets/img/basketball.png" /><span>TEAM</span></th>
          </tr>
          </thead>
          <tbody id="tbody">
          </tbody>

...
$(document).ready(function(){
  ...
  <?php $tid = $this->page_model->get_coachTeam($coach->COACH_ID);
    ...
    cur+="<tr onclick=\"window.location ='<?php echo base_url().'pages_controller/view_coach/'.$coach->COACH_ID;?>'\"><td style='text-align: center;' class='table-content'><img class='table-img' src='<?php echo base_url();?>assets/img/coach/<?php echo $coach->COACH_PORTRAIT_PHOTO?>'width='70'/> <?php echo $coach->COACH_FULLNAME;?></td><td style='text-align: center;' class='table-content'><img class='table-img' src='<?php echo base_url();?>assets/img/team/<?php echo $team->TEAM_LOGO?>' width='70'/><?php echo $team->TEAM_NAME;?></td></tr>";
  <?php endforeach;?>
  $("#tbody").append(cur);
